 ...
 */
(globalThis.webpackChunkNutrientViewer=globalThis.webpackChunkNutrientViewer||[]).push([[2210],{47928:()=>{Intl.PluralRules&&"function"==typeof Intl.PluralRules.__addLocaleData&&Intl.PluralRules.__addLocaleData({data:{categories:{cardinal:["one","many","other"],ordinal:["one","other"]},fn:function(e,a){var l=String(e),t=l.split(/[ce]/),n=t[1]||0,r=String(n?Number(t[0])*Math.pow(10,n):l).split("."),o=r[0],i=!r[1],u=o.slice(-6);return a?1==e?"one":"other":e>=0&&e<2?"one":0==n&&0!=o&&0==u&&i||n<0||n>5?"many":"other"}},locale:"fr"})}}]);